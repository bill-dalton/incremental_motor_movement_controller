...
static const float EL_SE_DEGREES_PER_ENCODER_COUNT = 0.0047940056; //Sept 2019 corrected pulley ratio to 2.00:2.00
...
static const float EL_DEGREES_PER_MICROSTEP = 0.0011985014;  //180.51:1 gear ratio Sept 2019 arm configuration corrected pulley ratio to 2.00:2.00
...
//  Timer1.initialize(500000);  //Timer1 fires to change i.e. update stepper velocity
  ...
  nh.loginfo("incremental_motor_movement_controller non-blocking version V0.0.03 9/19/2019");
  nh.spinOnce();
}// end setup()
